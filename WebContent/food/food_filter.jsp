...
<div class="col-lg-3 col-md-4 mt-sm-30 element-wrap posts-list">
  <div class="col-lg-12" style="background-color:white;">
	...
	<div class="single-element-widget">
	    ...
	    <div class="col-md-12 row nopadding">	    
		    <div class="custom-control custom-checkbox col-md-12 col-3">
			  <input type="checkbox" class="custom-control-input" name='check_type' id='check_rest' onclick="filter.check(this)" value='ㅇㄹㅇㄹ'/>
			  <label class="custom-control-label" for="check_rest">패밀리레스토랑</label>	  
		    </div>	    
			<div class="custom-control custom-checkbox col-md-12 col-4">
			  <input type="checkbox" class="custom-control-input" name='check_type' id='check_exo' onclick="filter.check(this)" value='바 & 펍'/>
			  <label class="custom-control-label" for="check_exo">이색음식점</label>
		    </div>
		    <div class="custom-control custom-checkbox col-md-12 col-5" >
			  <input type="checkbox" class="custom-control-input" name='check_type' id='check_veg' onclick="filter.check(this)" value='일반음식점'/>
			  <label class="custom-control-label" for="check_veg">채식전문점</label>
		    </div>
		    <div class="custom-control custom-checkbox col-md-12 col-4">
			  <input type="checkbox" class="custom-control-input" name='check_type' id='check_cafe' onclick="filter.check(this)" value='레스토랑'/>
			  <label class="custom-control-label" for="check_cafe">바 & 카페</label>	    
		    </div>
		    <div class="custom-control custom-checkbox col-md-12 col-4">
			  <input type="checkbox" class="custom-control-input" name='check_type' id='check_club' onclick="filter.check(this)" value='레스토랑'/>
	...
	<div class="single-element-widget">
	    ...
	    <div class="custom-control custom-checkbox col-md-12 col-3">
		  <input type="checkbox" class="custom-control-input" name='check_type' id='check_kor' onclick="filter.check(this)" value='한식'/>
		  <label class="custom-control-label" for="check_kor">한식</label>
	    </div>
		<div class="custom-control custom-checkbox col-md-12 col-3">
		  <input type="checkbox" class="custom-control-input" name='check_type' id='check_west' onclick="filter.check(this)" value='양식'/>
		  <label class="custom-control-label" for="check_west">서양식</label>
	    </div>
	    <div class="custom-control custom-checkbox col-md-12 col-3">
		  <input type="checkbox" class="custom-control-input" name='check_type' id='check_jap' onclick="filter.check(this)" value='일식'/>
		  <label class="custom-control-label" for="check_jap">일식</label>
	    </div>
	    <div class="custom-control custom-checkbox col-md-12 col-3">
		  <input type="checkbox" class="custom-control-input" name='check_type' id='check_chin' onclick="filter.check(this)" value='중식'/>
		  <label class="custom-control-label" for="check_chin">중식</label>
	    </div>    
	    <div class="custom-control custom-checkbox col-md-12 col-4">
		  <input type="checkbox" class="custom-control-input" name='check_type' id='check_asia' onclick="filter.check(this)" value='그외요리'/>
