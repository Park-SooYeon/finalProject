            ...
            <div class="mp-body-single">
              <div class="row">
                ...
                <div class="col-lg-6 p-0">
                  <ul class="mp-inner">
                    <li class="mp-hotel-name">지나버린 통일신라호텔</li>
              ...
              <div class="col-md-12 mb-3">
              	<button class="btn btn-outline-primary pull-right">상세보기</button>
                <button class="btn btn-primary pull-right mr-2">예약취소</button>
              </div>
          </div>