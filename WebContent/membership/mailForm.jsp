...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>[Travelista] 비밀번호 변경</strong></h1>
          <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br>
            [${member_id }님] &nbsp; 안녕하세요! </p>
        <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br>
                비밀번호 다시 설정하고 싶으신가요? 비밀번호를 다시 설정하시려면 아래 버튼을 클릭해주세요.</p>
    </div>
      ...
      <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
        <!--[if !mso]-->
        <a style="border-radius: 4px;display: inline-block;font-size: 14px;
        font-weight: bold;line-height: 24px;padding: 12px 24px;text-align:
         center;text-decoration: none !important;transition:opacity 0.1s ease-in;color: #ffffff !important;
          background-color: #38a4ff;font-family: Ubuntu, sans-serif;"
           href="http://localhost:8881/finalProject/?inc=membership/ChangePwd.jsp">
                 비밀번호 재설정하러 가기</a><!--[endif]-->
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://test.com" style="width:209px" arcsize="9%" fillcolor="#38A4FF" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">COMPLETE THE SURVEY</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p style="Margin-top: 0;Margin-bottom: 20px;"><p style="Margin-top: 20px;Margin-bottom: 20px;">만약 비밀번호 재설정을 요청하지 않으셨다면, 본 이메일에 응답하지 않으셔도 됩니다. 감사합니다!</p>
      </div>Travelista 드림</p>
      </div>
    </div>
