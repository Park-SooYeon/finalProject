...
var positions = [
	{
		content: '마커1',//makeContent(i['title'], i['mapx'], i['mapy']),
		latlng: new kakao.maps.LatLng(33.4581111174, 126.9415156012)
	}
];
...
$("#mapModal").on('shown.bs.modal', function() { // modal 이벤트 발생 시 지도 그리기
	...
	var mapOption = { //지도를 생성할 때 필요한 기본 옵션
			center: new kakao.maps.LatLng(33.4581111174, 126.9415156012), //지도의 중심좌표.
...
function makeContent(title, mapx, mapy) {
	let makeContent = '<div style="padding:5px;">' + title + ' <br>'
				+ '<a href="https://map.kakao.com/link/map/' + title + ',' + mapx + ',' + mapy + '" style="color:blue" target="_blank">큰지도보기</a>'
				+ '<a href="https://map.kakao.com/link/to/' + title + ',' + mapx + ',' + mapy + '" style="color:blue" target="_blank">길찾기</a>';
				+ '</div>';
...
function makePosition() {
	for(let i of filter.allItems) {
		let pos = {
			content: '왜 마커 안떠!!!',//makeContent(i['title'], i['mapx'], i['mapy']),
			latlng: new kakao.maps.LatLng(i['mapy'], i['mapx'])
		}
